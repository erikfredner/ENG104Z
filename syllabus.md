...
A digital copy of *Slaughterhouse* is [available from the Library](https://search.library.oregonstate.edu/permalink/01ALLIANCE_OSU/1c3q896/alma991299927101865).

You can purchase a physical copy for less than $20. I recommend checking these sites first:

- [OSU Beaver Store](https://osubeaverstore.com/)
...
1. Describe genres, forms, perspectives, events, and/or ideas that have
    shaped and recorded the human experience.

2. Analyze examples of human expression and/or human perspectives in
    changing cultural and/or historical contexts.
...
2. Identify how literary devices and various formal elements contribute
    meaning to a text.
...
- Extension requests made within 48 hours of a deadline for foreseeable reasons will likely be rejected.
  - For example, if a deadline in this class conflicts with a deadline in another course, that is a foreseeable reason.
...
death. We will discuss those topics as they arise in our reading. Please
consider whether you are comfortable reading and writing about those
topics this term. There won't be individual content warnings on each
story.

As a member of this classroom community, please be thoughtful and
respectful about how you write about difficult topics. Remember that a
fictional scene for you might be lived experience for someone else, and
it can be difficult to know how our words impact others. Please use
compassion and common sense when speaking about these issues in
discussion boards.
...
[**Custom GPT**](https://chatgpt.com/g/g-694188684cd481918fcf8f700673cd02-introduction-to-fiction-tutor)
...
Additionally, Canvas, the learning management system through which this
